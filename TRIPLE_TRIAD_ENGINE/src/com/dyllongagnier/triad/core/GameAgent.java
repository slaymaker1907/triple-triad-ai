...
/**
 * Implementing classes act as agents to play TripleTriad. When takeTurn is
 * called, the BoardState will wait for the called upon agent to make a valid
 * move. Agents should implement clone.
 */
